...
class CreditsView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Benjamín Herrera", 227, 440, arcade.color.BLACK, font_size=20,
                         anchor_x="center", font_name="Arial")
        arcade.draw_text("Eduardo Rojas", 227, 330, arcade.color.BLACK, font_size=20,
                         anchor_x="center", font_name="Arial")
        arcade.draw_text("Valentina Bosco", 560, 440, arcade.color.BLACK, font_size=20,
                         anchor_x="center", font_name="Arial")
        arcade.draw_text("Victoria Pagueguy", 560, 330, arcade.color.BLACK, font_size=20,
                         anchor_x="center", font_name="Arial")
